...
suite('date', () ->
  ...
  test('Date -> Undefined', () ->
    converter = ko.typeRestricted.getConverter('Date', 'Undefined')
  ...
  test('Date -> String', () ->
    converter = ko.typeRestricted.getConverter('Date', 'String')
  ...
  test('Date -> Moment', () ->
    converter = ko.typeRestricted.getConverter('Date', 'Moment')
